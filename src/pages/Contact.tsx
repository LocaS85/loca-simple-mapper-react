              ...
              <CardContent className="space-y-4">
                {isSubmitted ? (
                  <div className="bg-green-50 text-green-700 p-4 rounded-md">
                    ...
                    <p className="text-sm mt-1">Merci de nous avoir contacté. Nous vous répondrons dès que possible.</p>
                  </div>
                ) : (
                  <>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-1">
                    <a href="mailto:contact@locasimple.com" className="text-blue-600 hover:underline">
              ...
              <div className="pt-6 border-t border-gray-200 mt-6">
                <h3 className="text-sm font-medium mb-3">Suivez-nous</h3>
